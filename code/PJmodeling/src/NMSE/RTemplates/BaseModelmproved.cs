...
namespace NMSE.RTemplates
{
    ...
    #line 1 "C:\NMSE_final\NMSE\NMSE\RTemplates\BaseModelmproved.tt"
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "17.0.0.0")]
    public partial class BaseModelmproved : BaseModelmprovedBase
    {
#line hidden
        /// <summary>
        ...
        public virtual string TransformText()
        {
            ...
            this.Write("# This code has been generated with version 0.9 of the \'Markov Patient Journey Mo" +
                    ...
                    "\r\n#");
            this.Write("\r\n# Model Type: Base Model (improved version)\r\n\r\n");
...
");
            ...
            #line 26 "C:\NMSE_final\NMSE\NMSE\RTemplates\BaseModelmproved.tt"
...
int RemProbT5 = SimProb.Instance.ParamRemissionProbT5;
            ...
            #line 34 "C:\NMSE_final\NMSE\NMSE\RTemplates\BaseModelmproved.tt"
            ...
            #line 35 "C:\NMSE_final\NMSE\NMSE\RTemplates\BaseModelmproved.tt"
            ...
            #line 36 "C:\NMSE_final\NMSE\NMSE\RTemplates\BaseModelmproved.tt"
            ...
            #line 37 "C:\NMSE_final\NMSE\NMSE\RTemplates\BaseModelmproved.tt"
            ...
            #line 38 "C:\NMSE_final\NMSE\NMSE\RTemplates\BaseModelmproved.tt"
            ...
            #line 100 "C:\NMSE_final\NMSE\NMSE\RTemplates\BaseModelmproved.tt"
            ...
            #line 107 "C:\NMSE_final\NMSE\NMSE\RTemplates\BaseModelmproved.tt"
...
var_treatment_initiation_time <- ");
            ...
            #line 121 "C:\NMSE_final\NMSE\NMSE\RTemplates\BaseModelmproved.tt"
            ...
            #line 122 "C:\NMSE_final\NMSE\NMSE\RTemplates\BaseModelmproved.tt"
            ...
            #line 123 "C:\NMSE_final\NMSE\NMSE\RTemplates\BaseModelmproved.tt"
            ...
            #line 129 "C:\NMSE_final\NMSE\NMSE\RTemplates\BaseModelmproved.tt"
            ...
            this.Write("\r\n\r\n# Convention\r\n# default_base_model_export_rates.RDS\r\n# default_base_improved_" +
                    ...
                    "24, 0.15481,\r\n                             0.21804, 0.61924, 0.16272), ncol = 3," +
                    " byrow = TRUE)\r\n\r\n# values_to_assign\r\n# Assign values to specific rows in states" +
                    "_to_fit matrix\r\n\r\n# row then column\r\n\r\nfor (targetrow in 1:number_of_cycles_t)\r\n" +
                    "{\r\n  if (targetrow == t_vec[1]) {\r\n    states_to_fit[targetrow,] <- values_to_as" +
                    "sign[1,]\r\n  }\r\n  else if (targetrow < t_vec[2])\r\n  {\r\n    states_to_fit[targetro" +
                    "w,] <- c(0,0,0)\r\n  }\r\n  else if (targetrow == t_vec[2])\r\n  {\r\n    states_to_fit[" +
                    "targetrow,] <- values_to_assign[2,]\r\n  }\r\n  else if (targetrow < t_vec[3])\r\n  {\r" +
                    "\n    states_to_fit[targetrow,] <- c(0,0,0)\r\n  }\r\n  else if (targetrow == t_vec[3" +
                    "])\r\n    states_to_fit[targetrow,] <- values_to_assign[3,]\r\n  else \r\n  {\r\n    sta" +
                    "tes_to_fit[targetrow,] <- c(0,0,0)\r\n  }  \r\n}\r\n\r\nresidual <- function(variables) " +
                    "{\r\n  \r\n  # Assuming model_diseasestates is a predefined function\r\n  temp <- mode" +
                    "l_diseasestates(variables)\r\n  \r\n  # Calculate residuals: element-wise difference" +
                    ", square, and sum\r\n  res <- (states_to_fit[t_vec_new[1:3], ] - temp[t_vec_new[1:" +
                    "3], ])^2\r\n  \r\n  # Sum the squared differences\r\n  return(sum(res))\r\n}\r\n\r\n#print(s" +
                    "tates_to_fit)\r\n#print(t_vec)\r\n#print(t_vec_new)\r\n\r\n## ##########################" +
                    "############\r\n## Initial Parameters for 3x3 Matrix  ##\r\n## #####################" +
                    "################\r\n\r\nstart_params <- c(0.77787582,\t0.17507001,\t0.04705417,\r\n     " +
                    "             0.06103425,\t0.87135745,\t0.0676083,\r\n                  0.06558476,\t0" +
                    ".25724965,\t0.67716559)\r\n\r\n\r\n## Print previously read data\r\n# print(df_rates)\r\n# " +
                    "print(df_UCT)\r\n# print(df_diseasestates_input)\r\n# print(df_remission)\r\n\r\n# Fit t" +
                    "he model using least squares\r\n\r\nout <- stats::optim(start_params, residual, meth" +
                    "od = \"L-BFGS-B\", lower = 0, upper = 1)\r\n\r\n# out <- trustOptim::trust.optim(start" +
                    "_params, residual, grad, hess, method=\"Sparse\")\r\n# diseaseprobabilities_fitted i" +
                    "s for control\r\n# Reshape der 1D-Array in eine 3x3-Matrix\r\n\r\ndiseaseprobabilities" +
                    "_fitted <- matrix(out$par, nrow = 3, ncol = 3, byrow = TRUE)\r\n\r\n# Normalisierung" +
                    " der Zeilen der Matrix mit der L1-Norm\r\ndiseaseprobabilities_fitted <- t(apply(d" +
                    "iseaseprobabilities_fitted, 1, function(row) row / sum(abs(row))))\r\n\r\n# Anzeige " +
                    "der normalisierten Matrix \r\nprint(diseaseprobabilities_fitted)\r\n\r\n## ###########" +
                    "########################### ##\r\n## Export Model and actual Data ##########\r\n## #" +
                    "##################################### ##\r\n    \r\n  readr::write_rds(model_disease" +
                    "states(out$par), file.path(path_data_folder, \"diseasestates_model.rds\"))\r\n  read" +
                    "r::write_csv(as.data.frame(model_diseasestates(out$par)), file.path(path_data_fo" +
                    "lder, \"diseasestates_model.csv\"))\r\n  writexl::write_xlsx(as.data.frame(model_dis" +
                    "easestates(out$par)), file.path(path_data_folder, \"diseasestates_model.xlsx\"))\r\n" +
                    "  \r\n#  df_diseasestates_input_df <- as.data.frame(df_diseasestates_input)\r\n#  re" +
                    "adr::write_rds(df_diseasestates_input_df, file.path(path_data_folder, \"diseasest" +
                    "ates_input.rds\"))\r\n#  readr::write_csv(df_diseasestates_input_df, file.path(path" +
                    "_data_folder, \"diseasestates_input.csv\"))\r\n#  writexl::write_xlsx(df_diseasestat" +
                    "es_input_df, file.path(path_data_folder, \"diseasestates_input.xlsx\"))\r\n\r\n# #####" +
                    ...
                    "time <- 1  # time for rateMatrix in weeks\r\ntransMatrix <- 1 - exp(-rateMatrix / " +
                    "time)\r\ntransMatrix[6:8, 6:8] <- diseaseprobabilities_fitted\r\n\r\n# set diagonal el" +
                    "ements to 0 and calculate diagonal elements as 1-(row sum)\r\n\r\ntransMatrix <- rec" +
                    "alculate_main_diagonal(transMatrix)\r\ncheck_matrix_row_sum(transMatrix)\r\n\r\n# Prin" +
                    "t transition matrix\r\n# Save matrices and states to CSV files\r\n\r\nreadr::write_csv" +
                    "(as.data.frame(rateMatrix), file.path(path_data_folder, \"rateMatrix.csv\")) \r\nrea" +
                    "dr::write_csv(as.data.frame(transMatrix), file.path(path_data_folder, \"transMatr" +
                    "ix.csv\"))\r\nreadr::write_csv(as.data.frame(states), file.path(path_data_folder, \"" +
                    "states.csv\"))\r\n\r\nprint(round(transMatrix,3))\r\nprint(round(transMatrix[1:8, 9],3)" +
                    ")\r\nprint(states)\r\n\r\n## ####################################### # \r\n##    Time Ev" +
                    "olution and Steady State   #### \r\n## ####################################### # \r" +
                    ...
                    " #\r\n########################################### #\r\n\r\ntransMatrix_new <- transMat" +
                    "rix  \r\n\r\n# Imputation of new Values\r\n\r\n# 1a Diagnosis Rate: Symptomatic --> Diag" +
                    "nosed x% higher\r\n# Check whether Variable is 0 --> Set to 1 example (do we need " +
                    "this check?)\r\n\r\n#var_sym_diag_rate\r\ntransMatrix_new [1, 2] <- transMatrix[1, 2] " +
                    "* var_sym_diag_rate                            # Changed Diagnoses Rate\r\n#transM" +
                    "atrix_new [1, 3] <- transMatrix[1, 2] + transMatrix[1, 2] - transMatrix_new [1, " +
                    "2]   # Sum stays the same\r\n\r\n\r\n# 1b var_sym_diag_mean_time_weeks <- 104.3   mean" +
                    "time goes up diag_rate goes down (and vice versa)\r\nvar_sym_diag_mean_time_weeks_" +
                    "default <- 104.3\r\ntransMatrix_new [1, 2] <- transMatrix[1, 2] * (var_sym_diag_me" +
                    "an_time_weeks_default/var_sym_diag_mean_time_weeks)\r\n\r\n\r\n\r\n# 2 Treatment Rate: D" +
                    "iagnosed --> Treatment Start x% higher\r\ntransMatrix_new [2, 4] <- transMatrix[2," +
                    " 4] * var_diag_treat_rate                                          # Changed tre" +
                    "atment rate\r\n#transMatrix_new [2, 5] <- transMatrix[2, 5] + transMatrix[2,4] - t" +
                    "ransMatrix_new[2, 4] * var_diag_treat_rate  # Sum stays the same\r\n\r\n# 3 User pro" +
                    "vided parameters for treament start to ...\r\ntransMatrix_new [4, 6] <- ");
            
            #line 318 "C:\NMSE_final\NMSE\NMSE\RTemplates\BaseModelmproved.tt"
            ...
            #line 319 "C:\NMSE_final\NMSE\NMSE\RTemplates\BaseModelmproved.tt"
            ...
            #line 320 "C:\NMSE_final\NMSE\NMSE\RTemplates\BaseModelmproved.tt"
...
var_diagratio_edu <- ");
            ...
            #line 344 "C:\NMSE_final\NMSE\NMSE\RTemplates\BaseModelmproved.tt"
...
var_diagrate_awa <- ");
            ...
            #line 351 "C:\NMSE_final\NMSE\NMSE\RTemplates\BaseModelmproved.tt"
...
var_treatmentratio_treat <- ");
            ...
            #line 361 "C:\NMSE_final\NMSE\NMSE\RTemplates\BaseModelmproved.tt"
            ...
            this.Write("\r\n\r\ntransMatrix_dmp [2, 4] <- transMatrix[2, 4] + transMatrix[2, 4] * var_treatme" +
                    ...
                    " = c(0, 40),                  # Set x-axis limit from 0% to 40%\r\n  space = c(0.1" +
    ...
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "17.0.0.0")]
    public class BaseModelmprovedBase
    {
        #region Fields
